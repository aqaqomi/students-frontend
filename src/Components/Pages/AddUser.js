...
const AddUser = (props) => {
    ...
    const newData = async () => {
        ...
        if (input1.value && input4.value) {
            ...
            setAddLoading(true);
            setAdd2Error(false);
            axios.post(`${Config.API_URL}${Config.ADMIN_API}${Config.CREATE}/user`, {
                mobile: input1.value,
        ...
        <div className='bg-white border rounded md:max-w-[50%] md:mx-auto'>
            ...
            <div className='p-6'>
                ...
                <div className='bg-gray-50 p-4 rounded text-gray-500 text-sm mb-4 flex flex-row items-center justify-center'>
                    ...
                    <p className='mr-4'>
                    برای ایجاد یک کاربر جدید فرم زیر را تکمیل نمایید.
                    </p>
                </div>
                }
                <div className='flex flex-row items-center justify-between mb-2'>
                    <input id="input1" type="text" placeholder='تلفن همراه' className='border rounded p-1 w-full mx-1 text-sm' />
                </div>
